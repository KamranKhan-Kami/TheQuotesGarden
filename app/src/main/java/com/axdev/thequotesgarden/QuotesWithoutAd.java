...
public class QuotesWithoutAd extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quotes_without_ad);
        ...
        protected Void doInBackground(Void... unused) {
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    adapter = new QuotesListAdapter(QuotesWithoutAd.this, R.layout.quote_items, imageArry);
